...
export const addInvestorAccount = (company) => async (dispatch) => {
  const response = await fetch("/api/auth/add-investor-account", {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
    },
...
export const signUpInvestor =
  (email, password, investor_company) => async (dispatch) => {
